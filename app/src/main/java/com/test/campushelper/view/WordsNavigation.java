...
public class WordsNavigation extends android.support.v7.widget.AppCompatTextView {
    /*绘制的列表导航字母*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        wordsPaint.setColor(getCurrentTextColor());
        wordsPaint.setTextSize(getTextSize());
